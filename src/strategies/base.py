...
class Signal:
    ...
    # --- Dynamic portfolio risk adjustment (per-symbol LLM vote) ---
    portfolio_risk_adjustment_factor: Optional[float] = None  # 0.1–1.0, engine takes the min across all symbols
